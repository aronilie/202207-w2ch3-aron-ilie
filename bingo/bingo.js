let userChoice, turnNumber;

let idx = 0;

const attemptsIdx = 500, pointsIdx = 10;
...
function bingo() {
    ...
    newPlayer['name'] = prompt('Welcome to bingo game! Please enter your name to continue.');

    alert("Your punctuation will depend on the number of attempts you make LINE. The more attempts you make, the less points you get.")
    ...
    while (newCard) {
        ...
        userChoice = confirm("Your cartoon is shown in console. Press 'Accept' to continue or 'Cancel' for new cartoon.");
        ...
        if (userChoice) {
            ...
            if (bingoCardNumbers.indexOf(turnNumber) !== -1) {
                ...
                if (line) {
                    ...
                    alert('The turn number is ' + turnNumber + ". Congratulations! You made LINE.");

                    // Register attempts
                    newPlayer['attempts'] = attemptsCounter;

                    // Calculate and register points
                    newPlayer['points'] = Number(((attemptsIdx * pointsIdx) / ((attemptsCounter * attemptsCounter) / 100)).toFixed(1));
                } else {
                    // If it is not line
                    ...
                    userChoice = confirm('The turn number is ' + turnNumber + ". That number matches with one of your card! But you don't have line yet. Press 'Accept' for new turn.");
                }
            } else {
                ...
                userChoice = confirm("The turn number is " + turnNumber + ". That number doesn't match with any of your card. Press 'Accept' for new turn.");
            }
        }
    }
